...
//   let user = await userModel.findOne({ email: req.user.email }); //tocheck who is logged in
...
//   let post = await postModel.findOne({ _id: req.params.id }).populate("user"); //tocheck who is logged in
